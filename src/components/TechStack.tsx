...
function TechStack() {
  return (
    <div className="relative h-96 col-span-1 md:col-span-3 bg-black p-4 rounded-3xl group hover:shadow-xl transition duration-200 shadow-input border border-white/[0.2] flex flex-col space-y-4">
